export const shapeList = [
  {
    ...
    type: 'line',
    children: [
      { path: 'M 10 40 L 70 40', style: 'solid', points: ['', ''], data: [{ x: 0, y: 0 }, { x: 200, y: 0 }] },
      { path: 'M 10 40 L 70 40', style: 'dashed', points: ['', ''], data: [{ x: 0, y: 0 }, { x: 200, y: 0 }] },
      { path: 'M 40 10 L 40 70', style: 'solid', points: ['', ''], data: [{ x: 0, y: 0 }, { x: 0, y: 200 }] },
      { path: 'M 40 10 L 40 70', style: 'dashed', points: ['', ''], data: [{ x: 0, y: 0 }, { x: 0, y: 200 }] },
      { path: 'M 10 10 L 70 70', style: 'solid', points: ['', ''], data: [{ x: 0, y: 0 }, { x: 100, y: 200 }] },
      { path: 'M 70 10 L 10 70', style: 'solid', points: ['', ''], data: [{ x: 100, y: 0 }, { x: 0, y: 200 }] }
    ]
  },
  {
    title: '矩形',
